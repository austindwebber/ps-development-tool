...
<#RecoveryData:
#>
#endregion
<#
    .NOTES
    --------------------------------------------------------------------------------
     Code generated by:  SAPIEN Technologies, Inc., PowerShell Studio 2019 v5.6.159
     Generated on:       10/27/2019 2:42 PM
     Generated by:       Admin
    --------------------------------------------------------------------------------
    .DESCRIPTION
...
#region File Recovery Data (DO NOT MODIFY)
<#RecoveryData:
#>
#endregion
	#----------------------------------------------
	...
	$formScriptConverter = New-Object 'System.Windows.Forms.Form'
	$buttonBrowse = New-Object 'System.Windows.Forms.Button'
	$textboxFileSelected = New-Object 'System.Windows.Forms.TextBox'
	$labelSelectYourFileToConv = New-Object 'System.Windows.Forms.Label'
	...
	$buttonBrowse_Click={
		...
		{
			$textboxFileSelected.Text = $openfiledialog1.FileName
		}
	}
	
	
	
	$textboxFileSelected_TextChanged={
		if ($textboxFileSelected.Text -ne "")
		{
	...
	$Form_StateCorrection_Load=
	{
		...
		$formScriptConverter.WindowState = $InitialFormWindowState
	}
	
	$Form_StoreValues_Closing=
	{
		#Store the control values
		$script:PS1Converter_textboxFileSelected = $textboxFileSelected.Text
	}
	...
	$Form_Cleanup_FormClosed=
	{
		...
		try
		{
			...
			$textboxFileSelected.remove_TextChanged($textboxFileSelected_TextChanged)
			$buttonConvert.remove_Click($buttonConvert_Click)
			$formScriptConverter.remove_Load($formScriptConverter_Load)
			$openfiledialog1.remove_FileOk($openfiledialog1_FileOk)
			$formScriptConverter.remove_Load($Form_StateCorrection_Load)
			$formScriptConverter.remove_Closing($Form_StoreValues_Closing)
			$formScriptConverter.remove_FormClosed($Form_Cleanup_FormClosed)
		}
	...
	#----------------------------------------------
	$formScriptConverter.SuspendLayout()
	#
	# formScriptConverter
	#
	$formScriptConverter.Controls.Add($buttonBrowse)
	$formScriptConverter.Controls.Add($textboxFileSelected)
	$formScriptConverter.Controls.Add($labelSelectYourFileToConv)
	$formScriptConverter.Controls.Add($buttonConvert)
	$formScriptConverter.AutoScaleDimensions = '6, 13'
	$formScriptConverter.AutoScaleMode = 'Font'
	$formScriptConverter.BackColor = 'DarkRed'
	$formScriptConverter.ClientSize = '413, 62'
	$formScriptConverter.Margin = '4, 4, 4, 4'
	$formScriptConverter.Name = 'formScriptConverter'
	$formScriptConverter.StartPosition = 'CenterParent'
	$formScriptConverter.Text = 'Script Converter'
	$formScriptConverter.add_Load($formScriptConverter_Load)
	#
	# buttonBrowse
	#
	$buttonBrowse.Location = '369, 6'
	...
	# textboxFileSelected
	#
	$textboxFileSelected.AutoCompleteMode = 'SuggestAppend'
	$textboxFileSelected.AutoCompleteSource = 'FileSystem'
	$textboxFileSelected.Location = '152, 6'
	$textboxFileSelected.Name = 'textboxFileSelected'
	$textboxFileSelected.Size = '211, 20'
	$textboxFileSelected.TabIndex = 8
	$textboxFileSelected.add_TextChanged($textboxFileSelected_TextChanged)
	#
	# labelSelectYourFileToConv
	#
	$labelSelectYourFileToConv.AutoSize = $True
	$labelSelectYourFileToConv.ForeColor = 'White'
	$labelSelectYourFileToConv.Location = '12, 9'
	$labelSelectYourFileToConv.Name = 'labelSelectYourFileToConv'
	$labelSelectYourFileToConv.Size = '134, 17'
	$labelSelectYourFileToConv.TabIndex = 7
	$labelSelectYourFileToConv.Text = 'Select your file to convert:'
	$labelSelectYourFileToConv.UseCompatibleTextRendering = $True
	#
	# buttonConvert
	#
	$buttonConvert.Anchor = 'Bottom, Right'
	$buttonConvert.BackColor = 'Transparent'
	$buttonConvert.DialogResult = 'OK'
	$buttonConvert.Enabled = $False
	$buttonConvert.Location = '12, 32'
	$buttonConvert.Name = 'buttonConvert'
	$buttonConvert.Size = '388, 23'
	...
	$openfiledialog1.Filter = 'PowerShell Files (*.ps1)| *.ps1'
	$openfiledialog1.InitialDirectory = '\\cm\source'
	$openfiledialog1.add_FileOk($openfiledialog1_FileOk)
	$formScriptConverter.ResumeLayout()
	#endregion Generated Form Code

	#----------------------------------------------

	#Save the initial state of the form
	$InitialFormWindowState = $formScriptConverter.WindowState
	#Init the OnLoad event to correct the initial state of the form
	$formScriptConverter.add_Load($Form_StateCorrection_Load)
	#Clean up the control events
	$formScriptConverter.add_FormClosed($Form_Cleanup_FormClosed)
	#Store the control values when form is closing
	$formScriptConverter.add_Closing($Form_StoreValues_Closing)
	#Show the Form
	return $formScriptConverter.ShowDialog()
...
#region File Recovery Data (DO NOT MODIFY)
<#RecoveryData:
#>
#endregion
	#----------------------------------------------
	#region Import the Assemblies
	#----------------------------------------------
	...
	$buttonInstallationSwitchTe = New-Object 'System.Windows.Forms.Button'
	$buttonScriptConverter = New-Object 'System.Windows.Forms.Button'
	...
	$labelConsoleOutput = New-Object 'System.Windows.Forms.Label'
	...
	$checkboxCopyShortcutIntoPubl = New-Object 'System.Windows.Forms.CheckBox'
	$checkboxCopyShortcutIntoStar = New-Object 'System.Windows.Forms.CheckBox'
	...
	$buttonDev01 = New-Object 'System.Windows.Forms.Button'
	$buttonDev08 = New-Object 'System.Windows.Forms.Button'
	$buttonDev02 = New-Object 'System.Windows.Forms.Button'
	$buttonDev07 = New-Object 'System.Windows.Forms.Button'
	$buttonDev03 = New-Object 'System.Windows.Forms.Button'
	$buttonDev05 = New-Object 'System.Windows.Forms.Button'
	$buttonDev04 = New-Object 'System.Windows.Forms.Button'
...
"@
	...
	function generateScript
	{
		...
		if ($complete -match 'false')
		{
			
			Write-Host -ForegroundColor Green "Generating Scripts..."
			#Create installation script
			New-Item -Path $parentInstallationFile -Name $("install_" + $installationFileName + ".ps1") -ItemType File -Value $("#Silently installs " + $installationFileName + "`n#Script Auto-Generated by " + $env:USERNAME + ", Organization" +
        ...
        `n#Silently installs " + $installationFileName + "`nStart-Process" + ' "$PSScriptRoot\' + $installationFile + '"' + " -Wait -ArgumentList " + '"' + $switches + '"') -Force | Out-Null
			...
			if ($installationFileLocation -match '.msi' -and $productCode -ne "")
			{
				...
				New-Item -Path $parentInstallationFile -Name $("uninstall_" + $installationFileName + ".ps1") -ItemType File -Value $("#Silently uninstalls " + $installationFileName +
					"`n#Script Auto-Generated by " + $env:USERNAME + ", Organization" +
					"`n#Date Created " + $currentDate + "
			...
			if ($generateTestScript -eq "1")
			{
				...
				#Create Test Script
				New-Item -Path $($parentInstallationFile + "\_TEST_YOUR_APPLICATION\") -Name $("test_" + $installationFileName + ".ps1") -ItemType File -Value $("#Silently installs " + $installationFileName + "`n#Script Auto-Generated by " + $env:USERNAME + ", Organization" +
	...
	$buttonLaunchPowerShellAdmi_Click = {
		...
		$richtextbox2.AppendText("$currentTime Launched a resource.`n")
	}
	...
	$checkboxCopyShortcutIntoStar_CheckedChanged = {
	...
	$checkboxCopyShortcutIntoPubl_CheckedChanged = {
	...
	$buttonAustinsDevVM_Click={
		...
		$currentTime = Get-Date -format g
		$richtextbox2.AppendText("$currentTime Launched a VM.`n")
	}
	...
	$buttonScriptConverter_Click={
		#TODO: Place custom script here
		if ((Show-PS1Converter_psf) -eq 'OK')
		{
			$progressbar1.Value = 0
			$scriptFullFile = $PS1Converter_textboxFileSelected
			$scriptFileName = [io.path]::GetFileNameWithoutExtension($scriptFullFile)
			$scriptPath = Split-Path $scriptFullFile -Parent
			$scriptFinal = $($scriptPath + "\$scriptFileName.exe")
			$progressbar1.Value = 50
			PS2EXE -inputFile $scriptFullFile -outputFile $scriptFinal
			$progressbar1.Value = 100
			$currentTime = Get-Date -format g
			$richtextbox2.AppendText("$currentTime Converted $scriptFileName to an executable.`n")
		}
	}
	
	$buttonInstallationSwitchTe_Click={
		#TODO: Place custom script here
		if ((Show-InstallationSwitchTester_psf) -eq 'OK')
		{
			$progressbar1.Value = 0
			$scriptFullFile = $InstallationSwitchTester_textboxFileSelected
			$scriptSwitches = $InstallationSwitchTester_textboxInstallationSwitches
			$progressbar1.Value = 50
			Start-Process "$scriptFullFile" -Wait -ArgumentList "$scriptSwitches"
		}
	...
	{
		#Store the control values
		$script:PS_Development_Tool_richtextbox2 = $richtextbox2.Text
		...
		$script:PS_Development_Tool_checkboxCopyShortcutIntoPubl = $checkboxCopyShortcutIntoPubl.Checked
		$script:PS_Development_Tool_checkboxCopyShortcutIntoStar = $checkboxCopyShortcutIntoStar.Checked
	...
	$Form_Cleanup_FormClosed=
	{
		...
		try
		{
			$buttonInstallationSwitchTe.remove_Click($buttonInstallationSwitchTe_Click)
			$buttonScriptConverter.remove_Click($buttonScriptConverter_Click)
			...
			$checkboxCopyShortcutIntoPubl.remove_CheckedChanged($checkboxCopyShortcutIntoPubl_CheckedChanged)
			$checkboxCopyShortcutIntoStar.remove_CheckedChanged($checkboxCopyShortcutIntoStar_CheckedChanged)
			$buttonAustinsDevVM.remove_Click($buttonAustinsDevVM_Click)
			$buttonDev01.remove_Click($buttonDev01_Click)
			$buttonDev08.remove_Click($buttonDev08_Click)
			$buttonDev02.remove_Click($buttonDev02_Click)
			$buttonDev07.remove_Click($buttonDev07_Click)
			$buttonDev03.remove_Click($buttonDev03_Click)
			$buttonDev05.remove_Click($buttonDev05_Click)
			$buttonDev04.remove_Click($buttonDev04_Click)
	...
	#
	$formPSDevelopmentTool.Controls.Add($buttonInstallationSwitchTe)
	$formPSDevelopmentTool.Controls.Add($buttonScriptConverter)
	...
	$formPSDevelopmentTool.ClientSize = '738, 493'
	...
	#
	# buttonInstallationSwitchTe
	#
	$buttonInstallationSwitchTe.ForeColor = 'ControlText'
	$buttonInstallationSwitchTe.Location = '5, 421'
	$buttonInstallationSwitchTe.Name = 'buttonInstallationSwitchTe'
	$buttonInstallationSwitchTe.Size = '163, 23'
	$buttonInstallationSwitchTe.TabIndex = 24
	$buttonInstallationSwitchTe.Text = 'Installation Switch Tester'
	$buttonInstallationSwitchTe.UseCompatibleTextRendering = $True
	$buttonInstallationSwitchTe.UseVisualStyleBackColor = $True
	$buttonInstallationSwitchTe.add_Click($buttonInstallationSwitchTe_Click)
	#
	# buttonScriptConverter
	#
	$buttonScriptConverter.ForeColor = 'ControlText'
	$buttonScriptConverter.Location = '5, 392'
	$buttonScriptConverter.Name = 'buttonScriptConverter'
	$buttonScriptConverter.Size = '163, 23'
	$buttonScriptConverter.TabIndex = 23
	$buttonScriptConverter.Text = 'Script Converter'
	$tooltip1.SetToolTip($buttonScriptConverter, 'Launches .PS1 to .EXE converter')
	$buttonScriptConverter.UseCompatibleTextRendering = $True
	$buttonScriptConverter.UseVisualStyleBackColor = $True
	$buttonScriptConverter.add_Click($buttonScriptConverter_Click)
	#
	...
	# progressbar1
	#
	$progressbar1.Location = '87, 461'
	$progressbar1.Name = 'progressbar1'
	$progressbar1.Size = '470, 23'
	...
	$buttonCMsource.Text = 'Connect to \\cm'
	...
	$buttonGenerate.Enabled = $False
	$buttonGenerate.Location = '563, 461'
	...
	$tabcontrol1.Size = '552, 432'
	$tabcontrol1.TabIndex = 0
	#
	# Base
	#
	$Base.Controls.Add($richtextbox2)
	$Base.Controls.Add($labelConsoleOutput)
	...
	# richtextbox2
	#
	$richtextbox2.Location = '22, 240'
	$richtextbox2.Name = 'richtextbox2'
	$richtextbox2.ReadOnly = $True
	$richtextbox2.Size = '506, 141'
	$richtextbox2.TabIndex = 11
	$richtextbox2.Text = ''
	#
	# labelConsoleOutput
	#
	$labelConsoleOutput.AutoSize = $True
	$labelConsoleOutput.Font = 'Microsoft Sans Serif, 9.75pt, style=Bold'
	$labelConsoleOutput.Location = '22, 217'
	$labelConsoleOutput.Name = 'labelConsoleOutput'
	$labelConsoleOutput.Size = '105, 20'
	$labelConsoleOutput.TabIndex = 10
	$labelConsoleOutput.Text = 'Console Output:'
	$labelConsoleOutput.UseCompatibleTextRendering = $True
	#
	...
	$labelInstallationFileInfo.Location = '22, 121'
	...
	# richtextbox1
	#
	$richtextbox1.Location = '22, 147'
	$richtextbox1.Name = 'richtextbox1'
	$richtextbox1.ReadOnly = $True
	$richtextbox1.Size = '506, 58'
	$richtextbox1.TabIndex = 8
	$richtextbox1.Text = ''
	#
	# textboxSwitches
	#
	$textboxSwitches.Location = '221, 84'
	$textboxSwitches.Name = 'textboxSwitches'
	$textboxSwitches.Size = '307, 20'
	$textboxSwitches.TabIndex = 5
	#
	# textboxApplication
	#
	$textboxApplication.Location = '221, 35'
	$textboxApplication.Name = 'textboxApplication'
	$textboxApplication.Size = '307, 20'
	...
	$textboxFile.Location = '221, 60'
	$textboxFile.Name = 'textboxFile'
	$textboxFile.Size = '270, 20'
	...
	$labelEnterYourInstallatio.Location = '42, 87'
	...
	$labelSelectYourInstallati.Location = '42, 63'
	...
	$labelEnterTheNameOfTheApp.Location = '42, 38'
	...
	$labelScriptGenerator.Location = '22, 14'
	...
	# buttonBrowse
	#
	$buttonBrowse.Location = '497, 60'
	$buttonBrowse.Name = 'buttonBrowse'
	$buttonBrowse.Size = '31, 20'
	$buttonBrowse.TabIndex = 1
	$buttonBrowse.Text = '...'
	$tooltip1.SetToolTip($buttonBrowse, 'Browse for a file')
	$buttonBrowse.UseCompatibleTextRendering = $True
	$buttonBrowse.UseVisualStyleBackColor = $True
	$buttonBrowse.add_Click($buttonBrowse_Click)
	#
	...
	$AdditionalCode.Controls.Add($checkboxCopyShortcutIntoPubl)
	$AdditionalCode.Controls.Add($checkboxCopyShortcutIntoStar)
	$AdditionalCode.Location = '4, 22'
	$AdditionalCode.Name = 'AdditionalCode'
	$AdditionalCode.Padding = '3, 3, 3, 3'
	$AdditionalCode.Size = '544, 406'
	...
	$textboxDestinationPath.Location = '341, 66'
	...
	$textboxCopyFileFolder.Location = '143, 66'
	...
	$textBoxPublicDesktop.Location = '225, 38'
	$textBoxPublicDesktop.Name = 'textBoxPublicDesktop'
	$textBoxPublicDesktop.Size = '308, 20'
	...
	$textboxStartMenuShortcut.Location = '211, 8'
	$textboxStartMenuShortcut.Name = 'textboxStartMenuShortcut'
	$textboxStartMenuShortcut.Size = '322, 20'
	...
	#
	# checkboxCopyShortcutIntoPubl
	#
	$checkboxCopyShortcutIntoPubl.Location = '16, 36'
	$checkboxCopyShortcutIntoPubl.Name = 'checkboxCopyShortcutIntoPubl'
	$checkboxCopyShortcutIntoPubl.Size = '203, 24'
	$checkboxCopyShortcutIntoPubl.TabIndex = 1
	$checkboxCopyShortcutIntoPubl.Text = 'Copy Shortcut into Public Desktop?'
	$checkboxCopyShortcutIntoPubl.UseCompatibleTextRendering = $True
	$checkboxCopyShortcutIntoPubl.UseVisualStyleBackColor = $True
	$checkboxCopyShortcutIntoPubl.add_CheckedChanged($checkboxCopyShortcutIntoPubl_CheckedChanged)
	#
	# checkboxCopyShortcutIntoStar
	#
	$checkboxCopyShortcutIntoStar.Location = '16, 6'
	$checkboxCopyShortcutIntoStar.Name = 'checkboxCopyShortcutIntoStar'
	$checkboxCopyShortcutIntoStar.Size = '189, 24'
	$checkboxCopyShortcutIntoStar.TabIndex = 0
	$checkboxCopyShortcutIntoStar.Text = 'Copy Shortcut into Start Menu?'
	$checkboxCopyShortcutIntoStar.UseCompatibleTextRendering = $True
	$checkboxCopyShortcutIntoStar.UseVisualStyleBackColor = $True
	$checkboxCopyShortcutIntoStar.add_CheckedChanged($checkboxCopyShortcutIntoStar_CheckedChanged)
	#
	# AddOns
	#
	...
	$tooltip1.SetToolTip($checkboxGenerateTestScript, 'Creates a folder that contains testing scripts')
	...
	$groupbox2.Controls.Add($buttonDev01)
	$groupbox2.Controls.Add($buttonDev08)
	$groupbox2.Controls.Add($buttonDev02)
	$groupbox2.Controls.Add($buttonDev07)
	$groupbox2.Controls.Add($buttonDev03)
	$groupbox2.Controls.Add($buttonDev05)
	$groupbox2.Controls.Add($buttonDev04)
	...
	# buttonDev01
	#
	$buttonDev01.ForeColor = 'ControlText'
	$buttonDev01.Location = '7, 40'
	$buttonDev01.Name = 'buttonDev01'
	$buttonDev01.Size = '150, 23'
	$buttonDev01.TabIndex = 10
	$buttonDev01.Text = 'Dev-01'
	$buttonDev01.UseCompatibleTextRendering = $True
	$buttonDev01.UseVisualStyleBackColor = $True
	$buttonDev01.add_Click($buttonDev01_Click)
	#
	# buttonDev08
	#
	$buttonDev08.ForeColor = 'ControlText'
	$buttonDev08.Location = '6, 214'
	$buttonDev08.Name = 'buttonDev08'
	$buttonDev08.Size = '151, 23'
	$buttonDev08.TabIndex = 17
	$buttonDev08.Text = 'Dev-08'
	$buttonDev08.UseCompatibleTextRendering = $True
	$buttonDev08.UseVisualStyleBackColor = $True
	$buttonDev08.add_Click($buttonDev08_Click)
	#
	# buttonDev02
	#
	$buttonDev02.ForeColor = 'ControlText'
	$buttonDev02.Location = '7, 69'
	$buttonDev02.Name = 'buttonDev02'
	$buttonDev02.Size = '150, 23'
	$buttonDev02.TabIndex = 12
	$buttonDev02.Text = 'Dev-02'
	$buttonDev02.UseCompatibleTextRendering = $True
	$buttonDev02.UseVisualStyleBackColor = $True
	$buttonDev02.add_Click($buttonDev02_Click)
	#
	# buttonDev07
	#
	$buttonDev07.ForeColor = 'ControlText'
	$buttonDev07.Location = '6, 185'
	$buttonDev07.Name = 'buttonDev07'
	$buttonDev07.Size = '151, 23'
	$buttonDev07.TabIndex = 16
	$buttonDev07.Text = 'Dev-07'
	$buttonDev07.UseCompatibleTextRendering = $True
	$buttonDev07.UseVisualStyleBackColor = $True
	$buttonDev07.add_Click($buttonDev07_Click)
	#
	# buttonDev03
	#
	$buttonDev03.ForeColor = 'ControlText'
	$buttonDev03.Location = '7, 98'
	$buttonDev03.Name = 'buttonDev03'
	$buttonDev03.Size = '150, 23'
	$buttonDev03.TabIndex = 13
	$buttonDev03.Text = 'Dev-03'
	$buttonDev03.UseCompatibleTextRendering = $True
	$buttonDev03.UseVisualStyleBackColor = $True
	$buttonDev03.add_Click($buttonDev03_Click)
	#
	# buttonDev05
	#
	$buttonDev05.ForeColor = 'ControlText'
	$buttonDev05.Location = '7, 156'
	$buttonDev05.Name = 'buttonDev05'
	$buttonDev05.Size = '150, 23'
	$buttonDev05.TabIndex = 15
	$buttonDev05.Text = 'Dev-05'
	$buttonDev05.UseCompatibleTextRendering = $True
	$buttonDev05.UseVisualStyleBackColor = $True
	$buttonDev05.add_Click($buttonDev05_Click)
	#
	# buttonDev04
	#
	$buttonDev04.ForeColor = 'ControlText'
	$buttonDev04.Location = '7, 127'
	$buttonDev04.Name = 'buttonDev04'
	$buttonDev04.Size = '150, 23'
	$buttonDev04.TabIndex = 14
	$buttonDev04.Text = 'Dev-04'
	$buttonDev04.UseCompatibleTextRendering = $True
	$buttonDev04.UseVisualStyleBackColor = $True
	$buttonDev04.add_Click($buttonDev04_Click)
	#
	# tooltip1
	#
...
#region Source: InstallationSwitchTester.psf
function Show-InstallationSwitchTester_psf
{
#region File Recovery Data (DO NOT MODIFY)
<#RecoveryData:
#>
#endregion
	#----------------------------------------------
	#region Import the Assemblies
	#----------------------------------------------
	...
	#----------------------------------------------
	[System.Windows.Forms.Application]::EnableVisualStyles()
	$formInstallationSwitchTe = New-Object 'System.Windows.Forms.Form'
	$textboxInstallationSwitches = New-Object 'System.Windows.Forms.TextBox'
	$labelEnterYourInstallatio = New-Object 'System.Windows.Forms.Label'
	$labelSelectYourInstallati = New-Object 'System.Windows.Forms.Label'
	$textboxFileSelected = New-Object 'System.Windows.Forms.TextBox'
	...
	$textboxInstallationSwitches_TextChanged={
		if ($textboxInstallationSwitches.Text -ne "")
		{
	...
	{
		#Correct the initial state of the form to prevent the .Net maximized form issue
		$formInstallationSwitchTe.WindowState = $InitialFormWindowState
	}
	
	$Form_StoreValues_Closing=
	{
		#Store the control values
		$script:InstallationSwitchTester_textboxInstallationSwitches = $textboxInstallationSwitches.Text
		$script:InstallationSwitchTester_textboxFileSelected = $textboxFileSelected.Text
	}
	...
	$Form_Cleanup_FormClosed=
	{
		...
		try
		{
			$textboxInstallationSwitches.remove_TextChanged($textboxInstallationSwitches_TextChanged)
			$buttonRun.remove_Click($buttonRun_Click)
			$buttonBrowse.remove_Click($buttonBrowse_Click)
			$formInstallationSwitchTe.remove_Load($formInstallationSwitchTe_Load)
			$formInstallationSwitchTe.remove_Load($Form_StateCorrection_Load)
			$formInstallationSwitchTe.remove_Closing($Form_StoreValues_Closing)
			$formInstallationSwitchTe.remove_FormClosed($Form_Cleanup_FormClosed)
		}
		catch { Out-Null <# Prevent PSScriptAnalyzer warning #> }
	}
	#endregion Generated Events
	...
	#region Generated Form Code
	#----------------------------------------------
	$formInstallationSwitchTe.SuspendLayout()
	#
	# formInstallationSwitchTe
	#
	$formInstallationSwitchTe.Controls.Add($textboxInstallationSwitches)
	$formInstallationSwitchTe.Controls.Add($labelEnterYourInstallatio)
	$formInstallationSwitchTe.Controls.Add($labelSelectYourInstallati)
	$formInstallationSwitchTe.Controls.Add($textboxFileSelected)
	$formInstallationSwitchTe.Controls.Add($buttonRun)
	$formInstallationSwitchTe.Controls.Add($buttonBrowse)
	$formInstallationSwitchTe.AutoScaleDimensions = '6, 13'
	$formInstallationSwitchTe.AutoScaleMode = 'Font'
	$formInstallationSwitchTe.BackColor = 'DarkRed'
	$formInstallationSwitchTe.ClientSize = '431, 90'
	$formInstallationSwitchTe.Name = 'formInstallationSwitchTe'
	$formInstallationSwitchTe.Text = 'Installation Switch Tester'
	$formInstallationSwitchTe.add_Load($formInstallationSwitchTe_Load)
	#
	# textboxInstallationSwitches
	#
	$textboxInstallationSwitches.AutoCompleteMode = 'SuggestAppend'
	$textboxInstallationSwitches.AutoCompleteSource = 'FileSystem'
	$textboxInstallationSwitches.Location = '181, 33'
	$textboxInstallationSwitches.Name = 'textboxInstallationSwitches'
	$textboxInstallationSwitches.Size = '237, 20'
	$textboxInstallationSwitches.TabIndex = 15
	$textboxInstallationSwitches.add_TextChanged($textboxInstallationSwitches_TextChanged)
	#
	# labelEnterYourInstallatio
	#
	$labelEnterYourInstallatio.AutoSize = $True
	$labelEnterYourInstallatio.ForeColor = 'White'
	$labelEnterYourInstallatio.Location = '12, 36'
	$labelEnterYourInstallatio.Name = 'labelEnterYourInstallatio'
	$labelEnterYourInstallatio.Size = '163, 17'
	$labelEnterYourInstallatio.TabIndex = 14
	$labelEnterYourInstallatio.Text = 'Enter your installation switches:'
	$labelEnterYourInstallatio.UseCompatibleTextRendering = $True
	#
	# labelSelectYourInstallati
	#
	$labelSelectYourInstallati.AutoSize = $True
	$labelSelectYourInstallati.ForeColor = 'White'
	$labelSelectYourInstallati.Location = '12, 9'
	$labelSelectYourInstallati.Name = 'labelSelectYourInstallati'
	$labelSelectYourInstallati.Size = '138, 17'
	$labelSelectYourInstallati.TabIndex = 13
	$labelSelectYourInstallati.Text = 'Select your installation file:'
	$labelSelectYourInstallati.UseCompatibleTextRendering = $True
	#
	# textboxFileSelected
	...
	$textboxFileSelected.AutoCompleteMode = 'SuggestAppend'
	$textboxFileSelected.AutoCompleteSource = 'FileSystem'
	$textboxFileSelected.Location = '181, 6'
	$textboxFileSelected.Name = 'textboxFileSelected'
	$textboxFileSelected.Size = '205, 20'
	$textboxFileSelected.TabIndex = 12
	#
	# buttonRun
	#
	$buttonRun.Anchor = 'Bottom, Right'
	$buttonRun.BackColor = 'Transparent'
	$buttonRun.DialogResult = 'OK'
	$buttonRun.Enabled = $False
	$buttonRun.Location = '12, 59'
	$buttonRun.Name = 'buttonRun'
	$buttonRun.Size = '406, 23'
	...
	#
	$openfiledialog1.FileName = 'openfiledialog1'
	$formInstallationSwitchTe.ResumeLayout()
	#endregion Generated Form Code

	#----------------------------------------------

	#Save the initial state of the form
	$InitialFormWindowState = $formInstallationSwitchTe.WindowState
	#Init the OnLoad event to correct the initial state of the form
	$formInstallationSwitchTe.add_Load($Form_StateCorrection_Load)
	#Clean up the control events
	$formInstallationSwitchTe.add_FormClosed($Form_Cleanup_FormClosed)
	#Store the control values when form is closing
	$formInstallationSwitchTe.add_Closing($Form_StoreValues_Closing)
	#Show the Form
	return $formInstallationSwitchTe.ShowDialog()

}
#endregion Source: InstallationSwitchTester.psf
