...
<#
    ...
    --------------------------------------------------------------------------------
     ...
     Generated on:       2/25/2019 9:26 PM
     Generated by:       Admin
    --------------------------------------------------------------------------------
    .DESCRIPTION
...
"@
	...
	$buttonGenerate_Click = {
		...
		generateScript -installationFileLocation $textboxFile.Text -switches $textboxSwitches.Text -installationFileName $textboxApplication.Text -productCode $productCode -desktopIconName $textBoxPublicDesktop.Text -startMenuShortcut $textboxStartMenuShortcut.Text -copyOverFile $textboxCopyFileFolder.Text -copyIntoDirectory $textboxDestinationPath.Text -extraCode $textboxExtraCode.Text
	}
