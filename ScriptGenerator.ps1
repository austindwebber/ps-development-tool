...
function generateScript {
    ...
    if ($outsideofWD -eq "true" -and $complete -match 'false') {
        ...
        `n#Silently installs " + $applicationName + "`n" + '$parent = Split-Path -Path "$PSScriptRoot"' + "`nStart-Process" + ' "$parent\' + $installationFile + '"' + " -Wait -ArgumentList " + '"' + $switches + '"') -Force | Out-Null
